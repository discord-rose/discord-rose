...
export interface DiscordEventMap extends DiscordDefaultEventMap {
    'SHARD_READY': Shard;
    'GUILD_UNAVAILABLE': [CachedGuild | APIUnavailableGuild];
    'READY': null;
